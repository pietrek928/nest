...
def placement_anchor_inside_board(placed: Geometry, board_geom: Geometry) -> bool:
    """Nest anchor (center) inside board solid, including hole topology."""
    cx, cy = placed.center()
    return board_geom.contains_point(cx, cy)
...
def is_valid_placement(
    ...
    *,
    ...
    if not placement_anchor_inside_board(placed, scene.board_geom):
        return False
